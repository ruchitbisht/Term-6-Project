	...
	<div id="login-form">
		<div>
			<ul class="form-header">
				<li>
					<label for="signup"><i class="fa fa-credit-card"></i>User Registration Page</label>
				</li>
			</ul>
		</div>
			...
			<section class="login-section">
				<div class="login">
					<form:form method="Post" action="addUser" commandName="instUser">
						<ul class="ul-list">
							<li>
								<input type="number" required name="cartId" class="input" placeholder="cart Id"/>
							...
							<li>
								<input type="email" required name="email" class="input" placeholder="Your Email"/>
								<span class="icon"><i class="fa fa-user"></i></span></li>
							<li>
								<input type="number" required name="mobile" class="input" placeholder="Mobile Number"/>
							...
							<li>
								<input type="submit" value="Login User" class="btn">
							</li>
						</ul>
					</form:form>
				</div>
